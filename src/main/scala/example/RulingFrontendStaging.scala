...
object RulingFrontendStaging extends App {
  ...
  val stagingService = "https://www.staging.tax.service.gov.uk/search-for-advance-tariff-rulings/search?page=1"
